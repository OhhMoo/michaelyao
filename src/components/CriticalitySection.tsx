 ...
 */
const CRITICALITY_STEPS: DashboardStep[] = [
  {
    id: "crit-idea",
    tag: "01 / 05",
    label: "Criticality study — now viewing",
    heading: "The idea",
    meta: "The correlation length = layers a pattern can survive",
  },
  {
    id: "crit-signal",
    tag: "02 / 05",
    label: "Criticality study — now viewing",
    heading: "Signal length",
    meta: "Theory and simulation converge within a handful of layers",
    stats: [
      { k: "Stable fixed points", v: "1" },
      { k: "Weight scales probed", v: "3" },
    ],
  },
  {
    id: "crit-order-chaos",
    tag: "03 / 05",
    label: "Criticality study — now viewing",
    heading: "Order vs. chaos",
    meta: "Below critical: pairs collapse; above: driven apart",
    stats: [
      { k: "Tracked inputs", v: "2" },
      { k: "Regimes", v: "2" },
    ],
  },
  {
    ...
    tag: "04 / 05",
    label: "Criticality study — now viewing",
    heading: "The phase boundary",
    meta: "Initialise on the boundary to train at any depth",
    stats: [{ k: "Boundary condition", v: "χ₁ = 1" }],
  },
  {
    id: "crit-next",
    tag: "05 / 05",
    label: "Criticality study — now viewing",
    heading: "What's next",
    meta: "Reading hidden modes where closed-form theory breaks",
  },
];
    ...
    <section className="npage npage--crit" id="criticality">
      ...
      <div className="essay essay-dash">
        <div className="essay-dash-main">
          <FadeIn className="np-body np-col" id="crit-idea">
          ...
          <FadeIn className="np-body np-col" id="crit-signal">
          ...
          <FadeIn className="np-body np-col" id="crit-order-chaos">
          ...
          <FadeIn className="np-body np-col" id="crit-boundary">
          ...
          <FadeIn className="np-body np-col" id="crit-next">
        ...
        <ScrollDashboard steps={CRITICALITY_STEPS} ariaLabel="Criticality study — live section dashboard" />
      </div>
